...
export default function CSSBasico() {
  ...
  const disqusConfig = {
    url: "https://example.com/css-basico",
    identifier: "css-basico",
    title: "CSS Básico",
  };
        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <nav>
            <ul className="flex space-x-4">
              ...
              <li><a href="#propriedades" className="hover:text-blue-200 transition-colors duration-200">Propriedades CSS</a></li>
      ...
      <main className="container mx-auto p-6 space-y-12">
        ...
        <section id="estruturas" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <p className="text-lg mb-4">
            CSS é uma linguagem usada para definir a aparência dos elementos HTML. Aqui, vamos aprender sobre as estruturas básicas do CSS.
          </p>
...
<html lang="pt-br">
  ...
  <body>
    ...
    <p>Este é um exemplo básico de como usar CSS para estilizar uma página HTML.</p>
  </body>
</html>`}
            </code>
          </pre>
        ...
        <section id="propriedades" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h2 className="text-3xl font-bold mb-4 flex items-center">
            <FaCode className="mr-2 text-green-500" />
            Propriedades CSS Comuns
          </h2>
          <p className="text-lg mb-4">
            As propriedades CSS são usadas para definir o estilo de diferentes elementos HTML. Aqui estão algumas das mais utilizadas.
          </p>
          <pre className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg overflow-x-auto mb-4">
            <code>
...
padding: 20px; /* Preenchimento interno`}
        ...
        <section id="exercicios" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <ul className="list-decimal list-inside text-lg space-y-4">
            <li>Crie uma página HTML e use CSS para mudar a cor do texto e o fundo.</li>
            <li>Adicione um título com uma fonte grande e coloque uma borda em torno de um parágrafo.</li>
            <li>Use a propriedade `display: flex` para alinhar elementos de forma responsiva.</li>
            <li>Crie um curriculum em CSS</li>
          </ul>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <iframe
                title="CSS em uma hora"
                src="https://www.youtube.com/embed/wRNinF7YQqQ?si=U4D8qNRmM5P_5-xa"
        ...
        <section id="livros" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <ul className="space-y-4">
            <li className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              <strong>Artigo:</strong> <a href="https://medium.com/reprogramabr/descomplicando-o-css-pra-iniciantes-1e1ea9764d6c" className="text-blue-500 hover:underline">Guia completo: Descomplicando o CSS pra iniciantes</a>
            </li>
            <li className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              <strong>Artigo:</strong> <a href="https://medium.com/@gabrielmoraesmm/boas-práticas-para-programação-web-html-e-css-c2a62f1b9560" className="text-blue-500 hover:underline">Boas Práticas para Programação Web — HTML e CSS</a>
            </li>
            <li className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
              <strong>Artigo:</strong> <a href="https://www.devmedia.com.br/introducao-pratica-ao-css/40682" className="text-blue-500 hover:underline">Introdução prática ao CSS</a>
            </li>
          </ul>
        </section>
        ...
        <section id="cursos" className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                  ...
                  <ul className="space-y-4">
                    <li className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                      ...
                      <a
                        href="https://cursos.devsamurai.com.br/Frontend%20-%20CSS%20Grid.zip"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-blue-500 hover:underline"
                      > Frontend - CSS Grid - DEV Ninja
                      </a>
                    </li>
                  </ul>
                  <ul className="space-y-4">
                    <li className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                      <span className="font-bold">Curso 2:</span> 
                      <a
                        href="https://cursos.devsamurai.com.br/Frontend%20-%20Entendo%20o%20HTML%20com%20o%20CSS.zip"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-blue-500 hover:underline"
                      > CSS e HTML - DEV Ninja
                      </a>
                    </li>
                  </ul>
                </section>
